...
use Snoke\Websocket\Ratchet\Http\OriginCheck;
use Snoke\Websocket\Ratchet\Wamp\WampServerInterface;
use Snoke\Websocket\Ratchet\Server\IoServer;
use Snoke\Websocket\Ratchet\Server\FlashPolicy;
use Snoke\Websocket\Ratchet\Http\HttpServer;
use Snoke\Websocket\Ratchet\Http\Router;
use Snoke\Websocket\Ratchet\WebSocket\MessageComponentInterface as WsMessageComponentInterface;
use Snoke\Websocket\Ratchet\WebSocket\WsServer;
use Snoke\Websocket\Ratchet\Wamp\WampServer;
